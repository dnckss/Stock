...
export const HEATMAP_COLOR_POSITIVE = { r: 34, g: 139, b: 60 };
export const HEATMAP_COLOR_NEGATIVE = { r: 179, g: 30, b: 30 };
export const HEATMAP_COLOR_NEUTRAL = { r: 50, g: 50, b: 53 };
